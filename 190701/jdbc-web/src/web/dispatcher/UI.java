	...
	// make ui
		public static void build(HttpServletRequest request, String view) {
			if (view.equals("login")) {
				...
				request.setAttribute("center", "user/add"); // user 폴더 내 add.jsp
			}else if (view.equals("useraddimpl")) {
				request.setAttribute("navi", Navi.useradd);
				request.setAttribute("center", "user/rok"); // user 폴더 내 add.jsp
			} else if (view.equals("userlist")) {
				request.setAttribute("navi", Navi.userlist);
				request.setAttribute("center", "user/list"); // user 폴더 내 add.jsp
			}else if (view.equals("userdetail")) {
				request.setAttribute("navi", Navi.userdetail);
				request.setAttribute("center", "user/detail"); // user 폴더 내 add.jsp
			}else if (view.equals("userupdate")) {
				request.setAttribute("navi", Navi.userupdate);
				request.setAttribute("center", "user/update"); // user 폴더 내 add.jsp
				...
				request.setAttribute("navi", Navi.productadd);
				request.setAttribute("center", "product/pok"); // user 폴더 내 add.jsp
				...
				request.setAttribute("center", "product/detail"); // user 폴더 내 add.jsp
			}else if (view.equals("productupdate")) {
				request.setAttribute("navi", Navi.productupdate);
				request.setAttribute("center", "product/update"); // user 폴더 내 add.jsp
			}
		}
}
